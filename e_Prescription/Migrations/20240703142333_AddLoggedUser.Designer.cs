...
namespace e_Prescription.Migrations
{
    ...
    [Migration("20240703142333_AddLoggedUser")]
    partial class AddLoggedUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("e_Prescription.Models.Discharge", b =>
                {
                    ...
                    b.Property<int>("HealthcareProfessionalUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HealthcareProfessionalUserId");
            ...
            modelBuilder.Entity("e_Prescription.Models.Discharge", b =>
                {
                    ...
                    b.HasOne("e_Prescription.Models.Account.HealthcareProfessional", "HealthcareProfessional")
                        .WithMany()
                        .HasForeignKey("HealthcareProfessionalUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
