...
namespace e_Prescription.Migrations
{
    ...
    [Migration("20240819202445_MedIngreMod")]
    partial class MedIngreMod
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("e_Prescription.Models.PharmacyMedicationIngredient", b =>
                {
                    ...
                    b.Property<int>("PharmacyMedicationMedicationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PharmacyMedicationMedicationId");
            ...
            modelBuilder.Entity("e_Prescription.Models.PharmacyMedicationIngredient", b =>
                {
                    ...
                    b.HasOne("e_Prescription.Models.PharmacyMedication", "PharmacyMedication")
                        .WithMany()
                        .HasForeignKey("PharmacyMedicationMedicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
